...
public class AiShopService {
    ...
    public AiShopService(
            ChatClient.Builder chatClientBuilder,
            ShopAiTools shopTools) {

        this.chatClient = chatClientBuilder
                .defaultSystem("""
                        You are an AI assistant answering questions about different shops.
                        When asked what you can help with, make sure to only reply with functionalities
                        related to the function calls you can make.
                        Never say you can be asked for information which isn't explicitly available
                        through the function calls that are available to you.
